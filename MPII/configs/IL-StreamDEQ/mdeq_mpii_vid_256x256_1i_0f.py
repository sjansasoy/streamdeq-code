...
# model settings
model = dict(
    type='StreamDEQ_TopDown',
    pretrained='work_dirs/prtr_mdeq/mdeq_XL_cls_new.pkl',
    backbone=dict(
        type='MDEQNet',
        deq_cfg='configs/mdeq/mdeq_cls_cfg_26i.yaml'),
    keypoint_head=dict(
...
data = dict(
    ...
    val=dict(
        type='TopDownMpiiVidDataset',
        ann_file=f'{data_root}/annotations/mpii_val.json',
        img_prefix=f'{data_root}/val_videos/',
        data_cfg=data_cfg,
