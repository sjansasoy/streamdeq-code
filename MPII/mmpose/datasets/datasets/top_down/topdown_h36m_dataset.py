    ...
    def _get_db(self):
        ...
        for img_id in self.img_ids:
            ...
            for obj in objs:
                ...
                image_file = osp.join(self.img_prefix, self.id2name[img_id].split('_')[0], self.id2name[img_id][:-11], self.id2name[img_id])
    ...
    def evaluate(self, results, res_folder=None, metric='PCK', **kwargs):
        ...
        for result in results:
            ...
            for i in range(batch_size):
                image_id = self.name2id[image_paths[i][len(self.img_prefix):].split('/')[-1]]
