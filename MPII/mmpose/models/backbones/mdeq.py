...
from .lib.solvers import anderson, broyden, gd
...
#         func = SolverFunction(self.fullstage, cutoffs, x_list)
...
class SolverFunction(nn.Module):
    def __init__(self, fullstage, cutoffs, x_list):
        super().__init__()
        self.fullstage = fullstage
        self.cutoffs = cutoffs
        self.x_list = x_list
        
    def forward(self, z):
        out = list2vec(self.fullstage(vec2list(z, self.cutoffs), self.x_list))
        return out
